        ...
        <div class="payments row justify-content-center" style="width:100%;">
            <div class="payment-text-sec d-block justify-content-center" style="padding: 0px 50px;">
                ...
                <div class="payment-info">
                    ...
                    <span class="d-flex justify-content-start"><p class="payment-info-text" id="bankAccountNumber">{{$paymentMethod->bank_account_number}}</p>&emsp;<i class="fa-solid fa-copy fa-xl copy-icon" onclick="copyText('bankAccountNumber')"></i></span>
                </div>

                <div class="payment-info">
                    <p class="payment-info-title">Người thụ hưởng:</p>
                    <span class="d-flex justify-content-start"><p class="payment-info-text" id="bankAccountName">{{$paymentMethod->name_receiver}}</p>&emsp;<i class="fa-solid fa-copy fa-xl copy-icon" onclick="copyText('bankAccountName')"></i></span>
                </div>

                <div class="payment-info">
                    <p class="payment-info-title">Nội dung:</p>
                    <span class="d-flex justify-content-start"><p class="payment-info-text" id="bankAccountContent">{{$checkoutCode}}</p>&emsp;<i class="fa-solid fa-copy fa-xl copy-icon" onclick="copyText('bankAccountContent')"></i></span>
                </div>
                ...
                <div class="payment-info">
                    <span class="d-flex justify-content-start"><div class="four-dots" style="height:30px; width: 30px; margin:5px 0px;"></div><span>Đang đợi thanh toán</span></span>
                </div>
